...
$username = $password = $confirm_password = $address=$foodcat=$city="";
...
{
    $sql = "INSERT INTO users (username, password, address, foodcat, city) VALUES (?, ?,?,?,?)";
    $stmt = mysqli_prepare($conn, $sql);
    if ($stmt)
    {
        mysqli_stmt_bind_param($stmt, "sssss", $param_username, $param_password,$param_address,$param_foodcat, $param_city);

        // Set these parameters
        $param_username = $username;
        $param_password = password_hash($password, PASSWORD_DEFAULT);
        $param_address=$address;
        $param_foodcat=$foodcat;
        $param_city=$city; 
...
<form action="" method="post">
  <div class="form-row">
    ...
    <div class="form-group col-md-6">
      ...
      <input type="password" class="form-control" name ="password" id="inputPassword4" pattern=".{8,}" placeholder="Minimum 8 digits" required>
    </div>
  </div>
  ...
  <div class="form-gorup">
    <label for="inputAddress2">Select Food Category</label>
  <select name="foodcat" class="form-control" required>
  <option></option>
